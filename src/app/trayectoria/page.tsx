      ...
      <Box display={{ sm: "flex" }} sx={{ padding: "6%" }}>
        <Box width={{ sm: "50%" }} sx={{ paddingRight: { sm: "23px" } }}>
          ...
          >
            ...
            1975 en el Hospital San Luis de Aquitania. Desde muy joven, me
            dediqué a mis estudios y pasé por el Colegio Ramón Ignacio Avella
            hasta el grado octavo. Luego, completé mi bachillerato en un colegio
            militar en Bogotá, donde aprendí valiosas lecciones sobre
            disciplina,
            <span style={{ color: "#00873F", fontWeight: 700 }}>
            ...
            <br />
            <br />
            Después de graduarme, ingresé a la Universidad Santo Tomás de Bogotá
            y me convertí en{" "}
            <span style={{ color: "#00873F", fontWeight: 700 }}>
              ingeniero civil
            </span>{" "}
            ...
            <br />
            <br />
            Mi experiencia en el mundo de la agricultura y la comercialización
            de cebolla me permitió conocer a fondo a los agricultores,
            ...
            <span style={{ color: "#00873F", fontWeight: 700 }}>
              Asociación de Agricultores y Transportadores de Aquitania
              (ASOATRA).
            </span>
        ...
        >
          ...
          >
            ...
            logramos sortear la situación, incluso cuando los ingresos del
            sector del transporte disminuyeron significativamente debido a la
            pandemia. Durante mi gestión, destacamos por la construcción de un
            centro de mantenimiento en la ciudad de Yopal. Este centro cuenta
            con 24 habitaciones para los conductores, una cafetería,
            instalaciones de logística y mantenimiento, que incluyen lavaderos,
            cámaras de engrase y talleres de mecánica.
            <br />
            <br />
            ...
            . Sin embargo, debido a compromisos de tiempo relacionados con
            nuestra actual campaña, recientemete hice la entrega de este cargo.
          </Typography>
        </Box>
        <Box
          sx={{
